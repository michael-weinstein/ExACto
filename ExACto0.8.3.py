...
If you are copying a pre-cut library of ExAC data and the integrity check fails, you can start with the argument -i to recreate the hashsum (0.8.2 change).
Only do this if you are sure that no files were added or removed.
